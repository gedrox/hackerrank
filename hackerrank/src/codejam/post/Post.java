...
//            BitSet check = (BitSet) this.horseUsed.clone();
//            check.and(that.horseUsed);
            
            return this.km <= that.km && this.v <= that.v && this.t >= that.t;// && check.equals(that.horseUsed);
        }
    }
