...
public class BC2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int a0 = 0; a0 < m; a0++) {
            ...
            if (fin[u] != -1) edges[fin[u]][4] = edgeCnt;
            edges[edgeCnt] = new int[]{v, fin[u], a0, u, -1};
            if (first[u] == -1) first[u] = edgeCnt;
            fin[u] = edgeCnt++;

            if (fin[v] != -1) edges[fin[v]][4] = edgeCnt;
            edges[edgeCnt] = new int[]{u, fin[v], a0, v, -1};
        ...
        for (int i = 0; i < edgeCnt; i++) {
            ...
            if (edges[i][0] == edges[i][3]) {
                if (edges[i][4] == -1) {
                    fin[edges[i][3]] = edges[i][1];
                } else {
                    edges[edges[i][4]][1] = edges[i][1];
                }
            }
        }
